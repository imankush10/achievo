...
export const PublicProfile: React.FC<PublicProfileProps> = ({ userId = 'demo_user' }) => {
  const { profile, loading, isOwn, updateProfile, toggleProfileVisibility } = usePublicProfile(userId);
  ...
  if (!profile) {
    return (
      <div className="glass-panel p-6 text-center">
        ...
        <p className="text-neutral-400">This user's profile is private or doesn't exist.</p>
      </div>
    );
  }
      ...
      <div className="glass-panel p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-neutral-800/50 rounded-lg p-4 text-center">
            <div className="text-2xl font-bold text-white mb-1">{profile.stats.totalPlaylists}</div>
            <div className="text-xs text-neutral-400">Playlists</div>
          </div>
          
          <div className="bg-neutral-800/50 rounded-lg p-4 text-center">
            <div className="text-2xl font-bold text-white mb-1">{profile.stats.completedPlaylists}</div>
          ...
          <div className="bg-neutral-800/50 rounded-lg p-4 text-center">
            <div className="text-2xl font-bold text-white mb-1">
              {formatTime(profile.stats.totalLearningTime)}
            </div>
        ...
        {profile.stats.categoriesExplored.length > 0 && (
          <div className="mt-6">
            <h4 className="text-sm font-medium text-neutral-400 mb-3">Learning Areas</h4>
